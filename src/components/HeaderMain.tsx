...
const HeaderMain = () => {
  ...
  return (
    <div className="border-b    border-slate-800 py-2 sticky top-0 z-20 bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-100">
      <div className="container  sm:flex justify-between items-center ">
        <div className="font-semibold   text-2xl md:text-3xl lg:text-4xl text-center pb-4 sm:pb-0 text-[#15688c]">
